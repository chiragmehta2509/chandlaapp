                        ...
                        <form method="POST" action="{{ route('client.login') }}">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="text-right mt-2">
                                    <a href="{{ route('password.request') }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-200 hover:text-indigo-800 dark:hover:text-slate-900 dark:text-white">Forgot password?</a>
                                </div>
                            </div>

                            <div class="mb-6">
                                <label class="inline-flex items-center gap-2 text-sm text-slate-700 dark:text-white/80 cursor-pointer">
                                    <input type="checkbox" name="remember" class="h-4 w-4 rounded border-slate-300 dark:border-white/30 bg-white dark:bg-white/10 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-0" {{ \Illuminate\Support\Facades\Cookie::has('remembered_login') ? 'checked' : '' }}>
                                    Remember me
                                </label>
                            </div>
                            ...
                            <p class="mt-6 text-center text-sm text-slate-600 dark:text-white/70">
                                ...
                                <a href="{{ route('client.register') }}" class="font-semibold text-indigo-600 dark:text-white hover:underline">Register</a>
                            </p>
                        </form>
                    </div>

                    {{-- Card footer: Privacy & Terms --}}
