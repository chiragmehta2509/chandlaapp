                    ...
                    <div class="p-6 sm:p-8">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-slate-600 dark:text-white/70 mt-3 text-sm sm:text-base">
                                You are currently logged in as <strong class="text-slate-800 dark:text-white font-semibold">{{ Auth::user()->name ?: Auth::user()->email }}</strong>.
                            </p>
                        </div>

                        <div class="space-y-4">
                            <a href="{{ route('client.dashboard') }}" class="w-full inline-flex items-center justify-center rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3 px-4 shadow-lg shadow-indigo-900/20 transition duration-150 ease-in-out">
