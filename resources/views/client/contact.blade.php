        ...
        @if($hasContact)
            <div class="rounded-2xl border border-white/10 bg-gradient-to-br from-indigo-950 via-purple-900 to-slate-950 p-6 sm:p-8 shadow-2xl shadow-black/35 text-white">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @if($supportPhone !== '')
                    <a href="{{ $telUri }}" class="group flex items-center justify-between gap-4 rounded-xl border border-white/5 bg-white/[0.03] p-4 sm:p-5 transition-all duration-300 hover:bg-white/[0.08] hover:border-white/10 hover:shadow-lg hover:shadow-indigo-950/20">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <span class="block text-base sm:text-lg font-bold text-white tracking-wide">{{ $supportPhone }}</span>
                    ...
                    @if($supportEmail !== '')
                    <a href="mailto:{{ $supportEmail }}" class="group flex items-center justify-between gap-4 rounded-xl border border-white/5 bg-white/[0.03] p-4 sm:p-5 transition-all duration-300 hover:bg-white/[0.08] hover:border-white/10 hover:shadow-lg hover:shadow-indigo-950/20">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="min-w-0">
                                ...
                                <span class="block text-base sm:text-lg font-bold text-white tracking-wide truncate max-w-[180px] sm:max-w-xs">{{ $supportEmail }}</span>
