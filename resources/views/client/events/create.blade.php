...
<div class="w-full max-w-2xl mx-auto">
    ...
    <div class="cb-card">
        <form method="POST" action="{{ route('client.events.store') }}" class="p-4 sm:p-6 lg:p-8">
            @csrf

            @if(isset($freeEventCredits) && $freeEventCredits > 0)
                <div class="mb-6 rounded-xl border border-amber-200 bg-amber-50 p-4 flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-amber-900">You have {{ $freeEventCredits }} Free Event Credit(s)!</h3>
                        ...
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="redeem_coin" value="1" class="rounded border-amber-300 text-amber-600 focus:ring-amber-500" {{ (isset($autoRedeem) && $autoRedeem) ? 'checked' : '' }}>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                        <div class="sm:col-span-1">
                            ...
                            <input
                                ...
                                type="date"
                                name="event_date"
                                value="{{ old('event_date', $minEventDate) }}"
                                min="{{ $minEventDate }}"
                                required
                        ...
                        <div class="sm:col-span-2">
                            ...
                            @include('client.events.partials.event-type-select')
                        </div>
                    </div>
                </section>
            </div>
