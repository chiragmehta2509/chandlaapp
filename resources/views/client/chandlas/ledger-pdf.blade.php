            ...
            <div class="cover-frame-inner serif-title">
                ...
                <table class="cover-meta-table">
                    ...
                    <tr>
                        ...
                        <td class="val">{{ $cash->count() + $gpay->count() + $cover->count() + $gift->count() }} total rows</td>
                    </tr>
                    <tr>
            ...
            <tbody>
                ...
                @if($gpay->count() > 0)
                    <tr class="total-row" style="background:#d1fae5 !important;">
                        <td colspan="5" style="color:#065f46;">GPay section total &mdash; {{ $gpayCount }} transactions</td>
