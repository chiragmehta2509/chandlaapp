            ...
            <table class="promo-contact">
                @if($pdfContactEmail !== '')
                    <tr>
                        ...
                        <td>{{ $pdfContactEmail }}</td>
                    </tr>
                @endif
                @if($pdfContactPhone !== '')
                    <tr>
                        <td class="pt">Phone</td>
                        <td>{{ $pdfContactPhone }}</td>
                    </tr>
                @endif
                @if(!empty($pdfSiteHost))
                    <tr>
                        <td class="pt">Website</td>
                        <td>{{ rtrim(config('app.url'), '/') }}</td>
                    </tr>
                @endif
            </table>
        @else
        ...
        <table class="promo-plans">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="inr">&#8377;</span> {{ number_format($guestPayInr, 0) }}</td>
                ...
                <tr>
                    ...
                    <td><span class="inr">&#8377;</span> {{ number_format($dgUnlockInr, 0) }}</td>
