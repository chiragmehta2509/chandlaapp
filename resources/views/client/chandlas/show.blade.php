...
<div class="mb-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
        ...
        <div class="flex flex-col sm:flex-row gap-2 sm:items-center">
            <a href="{{ route('client.chandlas.create', ['event_id' => $chandla->event_id]) }}" class="bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 text-center">
                <i class="fas fa-plus mr-2"></i>Add another for this event
            </a>
            <a href="{{ route('client.chandlas.edit', $chandla->id) }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-center">
    ...
    <div class="lg:col-span-2">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-gray-900">
                        {{ $chandla->received_date->format('d/m/Y') }}
                        @if($chandla->created_at)
                            {{ $chandla->created_at->timezone(config('app.timezone'))->format('h:i A') }}
                        @endif
                    </p>
                </div>
                <div>
        ...
        <div class="bg-white rounded-lg shadow p-6 mt-6">
            ...
            <div class="flex justify-center">
                <a href="{{ route('client.gpay.view-image', $chandla->id) }}" target="_blank" class="inline-block">
                    <img src="{{ route('client.gpay.view-image', $chandla->id) }}" 
                         alt="GPay Screenshot" 
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900">{{ $chandla->created_at->timezone(config('app.timezone'))->format('d/m/Y h:i A') }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Last Updated</p>
                    <p class="text-sm font-medium text-gray-900">{{ $chandla->updated_at->timezone(config('app.timezone'))->format('d/m/Y h:i A') }}</p>
                </div>
            </div>
        </div>
    </div>
