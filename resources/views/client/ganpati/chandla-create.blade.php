...
@section('title', 'Add Chanda Entry — ' . $event->title)
...
<div class="max-w-xl mx-auto">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div class="min-w-0">
            ...
            <div class="flex items-center gap-2 mt-0.5">
                ...
                @canEdit
                <a href="{{ route('client.ganpati.edit', $event->id) }}" class="text-sky-500 hover:text-sky-700" title="Edit Event">
    ...
    <div class="gp-form-card">
        <form method="POST" action="{{ route('client.ganpati.chandla.store', $event->id) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="giver_name" name="giver_name" value="{{ old('giver_name') }}"
            ...
            <div class="mb-4">
                ...
                <textarea id="giver_address" name="giver_address" rows="2"
                          ...
                          class="cb-field w-full resize-none @error('giver_address') border-red-400 @enderror">{{ old('giver_address') }}</textarea>
            ...
            <div id="cash-notes-section" class="mb-4 gp-cash-notes">
                ...
                <div class="grid grid-cols-3 sm:grid-cols-5 gap-2">
                    ...
                    <div>
                        <label for="cn_{{ $denom }}" class="block text-[0.6rem] font-bold text-slate-500 dark:text-slate-400 mb-1">₹{{ $denom }}</label>
                        <input type="number" id="cn_{{ $denom }}" name="cash_note_{{ $denom }}"
                               value="{{ old('cash_note_' . $denom, 0) }}" min="0" step="1"
            ...
            <div id="gpay-section" class="mb-4 gp-gpay-section hidden">
                ...
                {{-- UPI Scanner / QR display (shown when event has UPI ID or scanner image) --}}
                ...
                <div class="rounded-xl border mb-4 overflow-hidden" style="border-color:var(--gp-border); background:var(--gp-bg-accent);">
                    <div class="px-3 py-2 flex items-center gap-2" style="border-bottom:1px solid var(--gp-border-soft);">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            @if($event->upi_id)
                            <p class="text-[0.65rem] font-mono truncate" style="color:var(--gp-muted);">{{ $event->upi_id }}</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4 p-4">
                        ...
                        <div class="flex flex-col items-center gap-1.5 shrink-0">
                            <div class="p-2 bg-white dark:bg-slate-900 rounded-xl shadow-sm" style="border:1.5px solid var(--gp-border);">
                                <img src="{{ route('client.ganpati.qr', $event->id) }}"
                                     alt="UPI QR Code"
                        ...
                        <div class="flex flex-col items-center gap-1.5 shrink-0">
                            <div class="p-2 bg-white dark:bg-slate-900 rounded-xl shadow-sm" style="border:1.5px solid var(--gp-border);">
                                <img src="{{ asset('storage/' . $event->gpay_qr_image) }}"
                                     alt="Scanner Image"
                ...
                <div class="mb-4 rounded-lg px-3 py-2 flex items-center gap-2 text-xs" style="background:rgba(234,88,12,0.08); border:1px solid var(--gp-border-soft); color:var(--gp-text);">
                    ...
                    <span>No UPI scanner added yet.
                        <a href="{{ route('client.ganpati.scanner', $event->id) }}" class="font-semibold underline" style="color:var(--gp-muted);" target="_blank">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="gpay_transaction_id" name="gpay_transaction_id"
                           value="{{ old('gpay_transaction_id') }}" maxlength="255"
            ...
            <div class="mb-4">
                ...
                <input type="date" id="received_date" name="received_date"
                       ...
                       class="cb-field w-full @error('received_date') border-red-400 @enderror">
            ...
            <div class="mb-5">
                ...
                <textarea id="notes" name="notes" rows="2" class="cb-field w-full resize-none">{{ old('notes') }}</textarea>
            </div>
