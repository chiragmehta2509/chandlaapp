...
<body style="font-family: Arial, sans-serif; color: #111827; line-height: 1.6;">
    ...
    <table cellpadding="6" cellspacing="0" border="0" style="border-collapse: collapse; margin-top: 12px;">
        <tr>
            ...
            <td>{{ $planDef['label'] }} <span style="color:#6b7280">(₹{{ number_format($planDef['price_inr'], 0) }})</span></td>
        </tr>
        <tr>
            <td><strong>User</strong></td>
            <td>{{ $user->name }} @if($user->email)&lt;{{ $user->email }}&gt;@endif @if($user->phone) · {{ $user->phone }}@endif</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="font-family: ui-monospace, monospace;">{{ $payment->transaction_id }}</td>
        </tr>
        <tr>
    ...
    <p style="margin-top: 20px;">
        <a href="{{ $adminUrl }}" style="background: #1A3646; color: #fff; padding: 10px 16px; border-radius: 8px; text-decoration: none; display: inline-block;">Open in admin panel</a>
    </p>
