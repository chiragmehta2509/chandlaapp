...
<body style="font-family: Arial, sans-serif; color: #111827; line-height: 1.6;">
    ...
    <table cellpadding="6" cellspacing="0" border="0" style="border-collapse: collapse; margin-top: 12px;">
        <tr>
            ...
            <td>{{ $event->title }} <span style="color:#6b7280">(id {{ $event->id }})</span></td>
        </tr>
        <tr>
    ...
    <p style="margin-top: 20px;">
        <a href="{{ $adminUrl }}" style="background: #4f46e5; color: #fff; padding: 10px 16px; border-radius: 8px; text-decoration: none; display: inline-block;">Open in admin panel</a>
    </p>
