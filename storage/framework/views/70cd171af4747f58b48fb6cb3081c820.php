...
<?php $__env->startSection('omit_footer_marketing_link'); ?>
...
<div class="max-w-4xl mx-auto pt-2">
    ...
    <?php if($hasContact): ?>
        <div class="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/[0.04] backdrop-blur-md p-6 sm:p-8 shadow-2xl shadow-black/30">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <?php if($supportPhone !== ''): ?>
                <a href="<?php echo e($telUri); ?>" class="group flex items-center justify-between gap-4 rounded-xl border border-slate-200 dark:border-white/5 bg-white/[0.03] p-4 sm:p-5 transition-all duration-300 hover:bg-white/[0.08] hover:border-slate-200 dark:border-white/10 hover:shadow-lg hover:shadow-indigo-950/20">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <span class="block text-base sm:text-lg font-bold text-slate-900 dark:text-white tracking-wide"><?php echo e($supportPhone); ?></span>
                ...
                <?php if($supportEmail !== ''): ?>
                <a href="mailto:<?php echo e($supportEmail); ?>" class="group flex items-center justify-between gap-4 rounded-xl border border-slate-200 dark:border-white/5 bg-white/[0.03] p-4 sm:p-5 transition-all duration-300 hover:bg-white/[0.08] hover:border-slate-200 dark:border-white/10 hover:shadow-lg hover:shadow-indigo-950/20">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="min-w-0">
                            ...
                            <span class="block text-base sm:text-lg font-bold text-slate-900 dark:text-white tracking-wide truncate max-w-[180px] sm:max-w-xs"><?php echo e($supportEmail); ?></span>
    ...
    <div class="mt-8 rounded-xl border border-slate-200 dark:border-white/10 bg-white/[0.04] px-4 py-4 text-sm text-slate-600 dark:text-white/70 leading-relaxed">
        ...
        <p>
            ...
            <a href="<?php echo e(url('/#faq')); ?>" class="font-semibold text-slate-900 dark:text-white underline decoration-slate-300 dark:decoration-white/35 underline-offset-2 hover:decoration-amber-300/80">FAQ</a>.
            For packs and pricing, see
            <a href="<?php echo e(url('/#pricing')); ?>" class="font-semibold text-slate-900 dark:text-white underline decoration-slate-300 dark:decoration-white/35 underline-offset-2 hover:decoration-amber-300/80">Plans</a>.
        </p>
    </div>
    ...
    <?php if(auth()->guard()->check()): ?>
        <p class="mt-8 text-center text-sm text-slate-500 dark:text-white/55">
            Signed in?
            <a href="<?php echo e(route('client.contact')); ?>" class="font-semibold text-slate-900 dark:text-white underline hover:text-amber-200">Account contact page</a>
        </p>
    <?php endif; ?>
</div>
<?php $__env->startPush('scripts'); ?>
...
<?php echo $__env->make('layouts.public-guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/public/contact.blade.php ENDPATH**/ ?>