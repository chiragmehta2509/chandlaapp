        ...
        <div class="flex-1 flex items-center justify-center px-4 py-8 sm:py-12">
            <div class="w-full max-w-md">
                <div class="bg-white dark:bg-white/10 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-white/20 p-6 sm:p-8 shadow-xl">
                    ...
                    <form method="POST" action="<?php echo e(route('password.email')); ?>">
                        ...
                        <p class="mt-6 text-center text-sm text-slate-600 dark:text-white/70">
                            Remembered it?
                            <a href="<?php echo e(route('client.login')); ?>" class="font-semibold text-indigo-600 dark:text-white hover:underline">Back to login</a>
                        </p>
                    </form>
                </div>
                ...
                <p class="text-center mt-6 text-xs text-slate-500 dark:text-white/50">
                    Need an account?
                    <a href="<?php echo e(route('client.register')); ?>" class="text-indigo-600 dark:text-indigo-200 hover:text-indigo-800 dark:hover:text-slate-900 dark:text-white">Get started</a>
                </p>
            </div>
        </div>

        <p class="text-center mt-8 text-xs text-white/45 px-4">
            <a href="<?php echo e(route('public.privacy')); ?>" class="hover:text-indigo-600 dark:hover:text-white/90">Privacy</a>
            <span class="mx-2">·</span>
            <a href="<?php echo e(route('public.terms')); ?>" class="hover:text-indigo-600 dark:hover:text-white/90">Terms</a>
        </p>
    </div>
    <script>
...
<?php /**PATH C:\Users\Chirag\Desktop\New folder\ChandlaBook\resources\views/client/auth/forgot-password.blade.php ENDPATH**/ ?>