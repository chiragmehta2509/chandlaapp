                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="background-color:#1a3646;border-radius:14px 14px 0 0;padding:26px 28px;text-align:center;border-bottom:4px solid #b8860b;">
                            <?php if(isset($message) && file_exists(public_path('images/chandla-logo.png'))): ?>
                                <img src="<?php echo e($message->embed(public_path('images/chandla-logo.png'))); ?>" alt="Chandla Book" width="150" style="display:block;margin:0 auto 14px;border:0;height:auto;max-width:150px;">
                            <?php elseif(file_exists(public_path('images/chandla-logo.png'))): ?>
                                <img src="<?php echo e(url('images/chandla-logo.png')); ?>" alt="Chandla Book" width="150" style="display:block;margin:0 auto 14px;border:0;height:auto;max-width:150px;">
                            <?php endif; ?>
