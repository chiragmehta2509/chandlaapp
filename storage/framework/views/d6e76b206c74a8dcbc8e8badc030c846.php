...
<head>
    ...
    <title>Pay — <?php echo e($event->title); ?> — Chandla Book</title>
...
<body class="min-h-screen relative overflow-x-hidden text-slate-800">
    ...
    <div class="relative z-10 max-w-md mx-auto px-4 sm:px-5 py-10 sm:py-14">
        <header class="text-center mb-8">
            <a href="<?php echo e(route('public.home')); ?>" class="inline-flex flex-col items-center gap-3 group no-underline">
                <div class="relative">
        ...
        <div class="rounded-2xl bg-white/95 backdrop-blur-sm shadow-2xl shadow-indigo-950/50 ring-1 ring-white/50 overflow-hidden">
            <div class="px-1 pt-1 pb-5 bg-gradient-to-r from-indigo-600/10 via-violet-500/10 to-sky-500/10">
                <div class="px-5 pt-5 pb-1">
                    ...
                    <h1 class="text-xl sm:text-2xl font-bold text-slate-900 leading-snug"><?php echo e($event->title); ?></h1>
            ...
            <form method="POST" action="<?php echo e(route('public.direct-gpay.prepare', ['event' => $event->id])); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="giver_name" value="<?php echo e(old('giver_name')); ?>" required maxlength="255"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="amount" value="<?php echo e(old('amount')); ?>" required step="0.01" min="1"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="village" value="<?php echo e(old('village')); ?>" required maxlength="255"
                               class="w-full border border-slate-200 rounded-xl pl-10 pr-4 py-3 bg-slate-50/80 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/80 focus:border-indigo-400 transition shadow-inner"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="giver_phone" value="<?php echo e(old('giver_phone')); ?>" required maxlength="20" inputmode="numeric"
                               class="w-full border border-slate-200 rounded-xl pl-10 pr-4 py-3 bg-slate-50/80 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/80 focus:border-indigo-400 transition shadow-inner"
...
<?php /**PATH /home/chandlabook/public_html/resources/views/public/direct-gpay-form.blade.php ENDPATH**/ ?>