        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900"><?php echo e($chandla->created_at->timezone(config('app.timezone'))->format('M d, Y h:i A')); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Last Updated</p>
                    <p class="text-sm font-medium text-gray-900"><?php echo e($chandla->updated_at->timezone(config('app.timezone'))->format('M d, Y h:i A')); ?></p>
                </div>
            </div>
        </div>
    </div>
