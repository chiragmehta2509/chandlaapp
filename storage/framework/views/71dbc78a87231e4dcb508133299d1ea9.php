...
<div class="max-w-2xl mx-auto pt-2">
    ...
    <div class="rounded-2xl bg-white text-slate-800 shadow-2xl shadow-slate-950/40 ring-1 ring-white/60 overflow-hidden">
        <div class="bg-gradient-to-r from-indigo-600/10 via-violet-500/10 to-sky-500/10 px-6 pt-6 pb-4 border-b border-slate-100">
            ...
            <h1 class="text-2xl font-bold text-slate-900 leading-tight"><?php echo e($event->title); ?></h1>
            <p class="text-sm text-slate-600 mt-2">
                You’re submitting a payment record for this event on Chandla Book.
                Organiser: <strong class="text-slate-800"><?php echo e($organizerLabel); ?></strong>
                <?php if($eventWhen): ?>
                    <span class="text-slate-500"> · <?php echo e($eventWhen); ?></span>
                <?php endif; ?>
                <?php if($event->venue): ?>
                    <span class="block mt-1 text-slate-500"><i class="fas fa-location-dot text-indigo-400 mr-1" aria-hidden="true"></i><?php echo e($event->venue); ?></span>
                <?php endif; ?>
            </p>
        </div>
        ...
        <div class="p-6 md:p-8">
            ...
            <form method="POST" action="<?php echo e(route('public.payment.submit', ['event' => $event->id, 'token' => request('token')])); ?>"
...
<?php echo $__env->make('layouts.public-guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/public/payment.blade.php ENDPATH**/ ?>