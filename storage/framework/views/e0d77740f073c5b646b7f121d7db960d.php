<?php $__env->startSection('title', 'Add New Subscription Plan'); ?>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g. VIP Host Pack" required
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" value="<?php echo e(old('slug')); ?>" placeholder="e.g. vip_host" required
                            class="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="1" min="0" name="amount_inr" value="<?php echo e(old('amount_inr', 0)); ?>" required
                    ...
                    <div>
                        ...
                        <input type="number" min="0" max="10" name="min_level" value="<?php echo e(old('min_level', 1)); ?>" required
                            class="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wide">Badge Tag</label>
                        <input type="text" name="badge" value="<?php echo e(old('badge', 'New Plan')); ?>"
                            class="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ...
                <div>
                    ...
                    <textarea name="description" rows="2" placeholder="Short summary of what this plan unlocks..."
                        class="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"><?php echo e(old('description')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="features" rows="5" placeholder="Up to 5 Events&#10;Unlimited Entries&#10;Priority 24/7 Support"
                        class="w-full rounded-xl border border-gray-300 p-4 text-sm font-mono leading-relaxed focus:outline-none focus:ring-2 focus:ring-indigo-500"><?php echo e(old('features')); ?></textarea>
                </div>
                ...
                <div class="border-t border-gray-100 pt-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="url" name="live_payment_url" value="<?php echo e(old('live_payment_url')); ?>"
                        ...
                        <div>
                            ...
                            <input type="url" name="test_payment_url" value="<?php echo e(old('test_payment_url')); ?>"
                                class="w-full rounded-xl border border-gray-300 px-4 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                placeholder="https://rzp.io/rzp/...">
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Chirag\Desktop\New folder\ChandlaBook\resources\views/admin/plans/create.blade.php ENDPATH**/ ?>