<?php $__env->startSection('title', 'Upgrade Required'); ?>
...
<div class="max-w-lg mx-auto py-12 px-4 text-center">
    ...
    <p class="text-slate-500 text-sm leading-relaxed mb-6">
        ...
        <strong class="text-cb-navy"><?php echo e($requiredPlan); ?></strong>
        and above.
        Your current plan is
        <strong class="text-slate-600"><?php echo e(config('packs.level_names.' . $userLevel, 'Starter Plan')); ?></strong>.
    </p>
    ...
    <div class="flex items-center justify-center gap-4 mb-8">
        ...
        <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-center min-w-[110px]">
            ...
            <p class="text-sm font-bold text-slate-700"><?php echo e(config('packs.level_names.' . $userLevel, 'Starter Plan')); ?></p>
        </div>
        ...
        <div class="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-center min-w-[110px] shadow-sm">
            ...
            <p class="text-sm font-bold text-amber-700"><?php echo e($requiredPlan); ?></p>
        </div>
    </div>

    
    <a href="<?php echo e($upgradeUrl); ?>" class="cb-btn cb-btn-gold justify-center px-8 py-3 text-base font-bold shadow-md w-full sm:w-auto">
        <i class="fas fa-rocket mr-2"></i> View Plans & Upgrade
    </a>

    <div class="mt-4">
        <a href="<?php echo e(route('client.dashboard')); ?>" class="text-sm text-slate-500 hover:text-cb-navy transition-colors">
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/errors/plan-required.blade.php ENDPATH**/ ?>