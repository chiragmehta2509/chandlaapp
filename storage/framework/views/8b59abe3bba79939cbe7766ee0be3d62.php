...
<div class="w-full max-w-2xl mx-auto">
    <header class="mb-6 sm:mb-8">
        ...
        <h1 class="cb-page-title mt-3 sm:mt-4">Add Expense</h1>
        <p class="cb-subtitle max-w-prose">Record an event-wise expense with payee and payment details.</p>
    </header>

    <div class="cb-card overflow-hidden">
        <form method="POST" action="<?php echo e(route('client.expenses.store')); ?>" enctype="multipart/form-data"
                            ...
                            <select id="exp-event-select" name="event_id" required class="cb-field min-h-[48px] w-full">
                                ...
                                <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($event->id); ?>"
                                        <?php echo e(old('event_id', $selectedEventId) == $event->id ? 'selected' : ''); ?>>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" id="exp-amount" name="amount"
                                           value="<?php echo e(old('amount')); ?>" required min="0" step="0.01"
                                           placeholder="0.00"
                    ...
                    <section aria-labelledby="exp-optional-desc-heading">
                        ...
                        <div>
                            ...
                            <textarea id="exp-description" name="description" rows="2"
                                      ...
                                      class="cb-field w-full resize-none"><?php echo e(old('description')); ?></textarea>
                        </div>
                    </section>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="exp-txn" name="transaction_id"
                                           value="<?php echo e(old('transaction_id')); ?>" maxlength="255"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="exp-receipt-no" name="receipt_number"
                                           value="<?php echo e(old('receipt_number')); ?>" maxlength="100"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-4 sm:space-y-5">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="exp-payee-name" name="payee_name"
                                           value="<?php echo e(old('payee_name')); ?>" maxlength="255"
                                ...
                                <div>
                                    ...
                                    <input type="tel" id="exp-payee-phone" name="payee_phone"
                                           value="<?php echo e(old('payee_phone')); ?>" maxlength="30"
                            ...
                            <div>
                                ...
                                <input type="text" id="exp-payee-upi" name="payee_upi"
                                       value="<?php echo e(old('payee_upi')); ?>" maxlength="255"
                    ...
                    <section aria-labelledby="exp-notes-heading" class="pt-2 sm:pt-4 border-t border-slate-200/80">
                        ...
                        <textarea id="exp-notes" name="notes" rows="3"
                                  ...
                                  class="cb-field w-full resize-none"><?php echo e(old('notes')); ?></textarea>
                    </section>
                </div>
                ...
                <div class="pt-2 sm:pt-4 border-t border-slate-200/80 flex flex-col sm:flex-row gap-3">
                    <button type="submit" class="cb-btn cb-btn--navy flex-1 justify-center">
                        <i class="fa-solid fa-save mr-2" aria-hidden="true"></i> Save Expense
                    </button>
                    <a href="<?php echo e(route('client.expenses.index')); ?>"
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Chirag\Desktop\New folder\ChandlaBook\resources\views/client/expenses/create.blade.php ENDPATH**/ ?>