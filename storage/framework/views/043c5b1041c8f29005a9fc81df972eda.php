...
<div class="mb-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-start">
        ...
        <a href="<?php echo e(route('client.events.edit', $event->id)); ?>" class="cb-btn cb-btn-ghost w-full sm:w-auto shrink-0 justify-center border-slate-200">
            ...
            <div class="relative z-10 grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 sm:mt-8 pt-5 border-t border-slate-100 dark:border-slate-700/60">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-cb-navy dark:text-white"><?php echo e($event->event_date->format('M d, Y')); ?> <?php if($event->event_time): ?> <span class="text-slate-400 font-normal ml-1"><?php echo e($event->event_time->format('h:i A')); ?></span> <?php endif; ?></p>
                    </div>
                </div>
...
<div class="cb-stat-strip-6 w-full shadow-sm border border-slate-200/90 dark:border-slate-700/80 mt-6">
    ...
    <div class="cb-stat-strip-6__cell">
        ...
        <div class="cb-stat-strip-6__body">
            <div class="cb-stat-strip-6__val text-cb-navy dark:text-white !overflow-visible !whitespace-normal !text-sm"><?php echo e($event->created_at->format('M d, Y')); ?></div>
                    ...
                    <?php $__currentLoopData = $event->chandlas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chandla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="chandla-row hover:bg-slate-50/60 transition-colors <?php echo e($chandla->payment_method === 'gpay' ? 'bg-teal-50/60' : ''); ?>">
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div class="text-sm text-slate-800"><?php echo e($chandla->received_date->format('M d, Y')); ?></div>
