...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        <?php if(!empty($pngExportScript)): ?> body.png-mid { background: #18181b !important; } <?php endif; ?>
...
<div class="capture-root">
    ...
    <p class="mg-sub"><?php echo e($d['tagline'] ?? 'Evening celebration'); ?></p>
    ...
    <?php endif; ?>
    <h1 class="mg-name"><?php echo e($d['groom_name'] ?? ''); ?></h1>
    <p class="mg-amp">&amp;</p>
    <h1 class="mg-name"><?php echo e($d['bride_name'] ?? ''); ?></h1>
    ...
    <div class="mg-detail">
        ...
        <div class="mg-addr"><?php echo e($d['venue_address'] ?? ''); ?></div>
    </div>
    <?php echo $__env->make('client.marriage-invitations.partials.schedule-block', ['d' => $d, 'wrapClass' => 'mg-sched', 'titleClass' => '', 'heading' => 'Schedule', 'rowClass' => 'mg-srow', 'titleCellClass' => 'mg-st', 'dotsClass' => 'mg-dots', 'whenClass' => 'mg-sw'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php if(!empty($d['rsvp_contact'])): ?><p class="mg-foot">RSVP: <?php echo e($d['rsvp_contact']); ?></p><?php endif; ?>
...
<?php /**PATH C:\Users\Chirag\Desktop\New folder\ChandlaBook\resources\views/client/marriage-invitations/templates/midnight_glam.blade.php ENDPATH**/ ?>