<?php $__env->startSection('title', 'Edit Chandla'); ?>

<?php $__env->startSection('content'); ?>
<div class="w-full max-w-2xl mx-auto">
    <header class="mb-6 sm:mb-8">
        <a
            href="<?php echo e(route('client.chandlas.show', $chandla->id)); ?>"
    ...
    <div class="cb-card overflow-hidden">
        <form method="POST" action="<?php echo e(route('client.chandlas.update', $chandla->id)); ?>" enctype="multipart/form-data" class="p-4 sm:p-6 lg:p-8">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6 sm:space-y-8">
                        ...
                        >
                            ...
                            <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($event->id); ?>"
                                    ...
                                    <?php echo e(old('event_id', $chandla->event_id) == $event->id ? 'selected' : ''); ?>>
                    ...
                    <div class="space-y-4 sm:space-y-5">
                        <div>
                            ...
                            <input type="text" name="giver_name" id="edit-giver-name"
                                value="<?php echo e(old('giver_name', $chandla->giver_name)); ?>"
                        ...
                        <div>
                            ...
                            <textarea name="giver_address" id="edit-giver-address" rows="2"
                                ...
                                placeholder="Street, area, city…"><?php echo e(old('giver_address', $chandla->giver_address)); ?></textarea>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                            <div>
                                ...
                                <input type="text" name="giver_phone" id="edit-giver-phone"
                                    value="<?php echo e(old('giver_phone', $chandla->giver_phone)); ?>"
                            ...
                            <div>
                                ...
                                <input type="email" name="giver_email" id="edit-giver-email"
                                    value="<?php echo e(old('giver_email', $chandla->giver_email)); ?>"
                ...
                <section aria-labelledby="edit-type-heading" class="pt-2 sm:pt-4 border-t border-slate-200/80">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-4">
                        <div>
                            ...
                            <select name="category" id="category" required class="cb-field min-h-[48px] w-full">
                                <option value="chandla" <?php echo e(old('category', $chandla->category) === 'chandla' ? 'selected' : ''); ?>>Cash</option>
                                <option value="cover"   <?php echo e(old('category', $chandla->category) === 'cover'   ? 'selected' : ''); ?>>Cover</option>
                                <option value="gift"    <?php echo e(old('category', $chandla->category) === 'gift'    ? 'selected' : ''); ?>>Gift</option>
                            </select>
                        </div>
                        <div id="payment_method_section">
                            ...
                            <select name="payment_method" id="payment_method" class="cb-field min-h-[48px] w-full">
                                <option value="cash" <?php echo e(old('payment_method', $chandla->payment_method) === 'cash'  ? 'selected' : ''); ?>>Cash</option>
                                <option value="gpay" <?php echo e(old('payment_method', $chandla->payment_method) === 'gpay'  ? 'selected' : ''); ?>>GPay</option>
                                <option value="other" <?php echo e(old('payment_method', $chandla->payment_method) === 'other' ? 'selected' : ''); ?>>N/A</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 sm:mb-6 p-4 rounded-xl border border-slate-200/90 bg-slate-50/50 space-y-4" id="gpay_fields"
                        style="display: <?php echo e(old('payment_method', $chandla->payment_method) === 'gpay' ? 'block' : 'none'); ?>;">
                        <div>
                            ...
                            <?php if($chandla->gpay_image): ?>
                                <div class="mb-3">
                                    ...
                                    <img src="<?php echo e(route('client.gpay.view-image', $chandla->id)); ?>" alt="GPay screenshot"
                    ...
                    <div id="gift_fields" class="mb-4 sm:mb-6 p-4 rounded-xl border border-slate-200/90 bg-slate-50/50 space-y-4"
                        style="display: <?php echo e(old('category', $chandla->category) === 'gift' ? 'block' : 'none'); ?>;">
                        <div>
                            ...
                            <input type="text" name="gift_item_name" id="gift_item_name"
                                value="<?php echo e(old('gift_item_name', $chandla->gift_item_name)); ?>"
                                class="cb-field min-h-[48px] w-full">
                        </div>
                        <div>
                            ...
                            <select name="gift_received" id="gift_received" class="cb-field min-h-[48px] w-full">
                                ...
                                <option value="1" <?php echo e(old('gift_received', (string) $chandla->gift_received) === '1' ? 'selected' : ''); ?>>Yes</option>
                                <option value="0" <?php echo e(old('gift_received', (string) $chandla->gift_received) === '0' ? 'selected' : ''); ?>>No</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="cash_notes" class="mb-4 sm:mb-6 p-4 sm:p-5 rounded-xl border border-slate-200/90 bg-white" style="display: none;">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                            <?php $__currentLoopData = [1,2,5,10,20,50,100,200,500]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <label class="block text-xs font-medium text-slate-600 mb-1.5">₹<?php echo e($note); ?></label>
                                <input type="number" name="cash_note_<?php echo e($note); ?>" min="0"
                                    value="<?php echo e(old('cash_note_'.$note, $chandla->{'cash_note_'.$note})); ?>"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 pt-2" id="amount_section">
                        ...
                        <div>
                            ...
                            <input type="date" name="received_date" id="received_date"
                                value="<?php echo e(old('received_date', $chandla->received_date->format('Y-m-d'))); ?>"
                    ...
                    <div class="space-y-4 sm:space-y-5">
                        <div>
                            ...
                            <input type="text" name="receipt_number" id="receipt_number"
                                value="<?php echo e(old('receipt_number', $chandla->receipt_number)); ?>"
                                class="cb-field min-h-[48px] w-full">
                        </div>
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="cb-field min-h-[5.5rem] resize-y w-full"><?php echo e(old('description', $chandla->description)); ?></textarea>
                        </div>
                        <div>
                            <label class="cb-label cb-label--classic" for="notes">Notes <span class="font-normal text-slate-400">(optional)</span></label>
                            <textarea name="notes" id="notes" rows="2"
                                class="cb-field min-h-[4rem] resize-y w-full"><?php echo e(old('notes', $chandla->notes)); ?></textarea>
                        </div>
                    </div>
                </section>
            ...
            <div class="mt-8 sm:mt-10 pt-5 sm:pt-6 border-t border-slate-200/80 flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
                <a href="<?php echo e(route('client.chandlas.show', $chandla->id)); ?>"
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/client/chandlas/edit.blade.php ENDPATH**/ ?>