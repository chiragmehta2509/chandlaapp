                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="background-color:#ffffff;padding:36px 32px 28px 32px;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
                            ...
                            <h1 style="margin:0 0 20px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;font-size:26px;font-weight:700;color:#0f172a;line-height:1.25;letter-spacing:-0.02em;">Hello, <?php echo e($user->name); ?></h1>
...
<?php /**PATH /home/chandlabook/public_html/resources/views/emails/password-changed.blade.php ENDPATH**/ ?>