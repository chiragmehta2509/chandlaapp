...
<div class="max-w-2xl mx-auto w-full min-w-0">
    <div class="mb-6 sm:mb-8">
        <a href="<?php echo e(route('client.contacts.show', $contact->id)); ?>"
    ...
    <div class="cb-card overflow-hidden border border-slate-200/80 shadow-sm rounded-2xl">
        ...
        <form method="POST" action="<?php echo e(route('client.contacts.update', $contact->id)); ?>" class="divide-y divide-slate-100">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-1.5 min-w-0">
                        ...
                        <div class="relative">
                            ...
                            <input id="contact-phone"
                                   ...
                                   inputmode="tel"
                                   name="phone"
                                   value="<?php echo e(old('phone', $firstPhone)); ?>"
                                   autocomplete="tel"
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Flat, landmark, city…"><?php echo e(old('address', $contact->address)); ?></textarea>
            ...
            <section class="space-y-5 p-4 sm:p-6 lg:p-8 py-8 sm:py-10" aria-labelledby="contact-extra-heading">
                ...
                <div class="space-y-1.5">
                    ...
                    <input id="contact-relationship"
                           type="text"
                           name="relationship"
                           value="<?php echo e(old('relationship', $contact->relationship)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Anything you want to remember"><?php echo e(old('notes', $contact->notes)); ?></textarea>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/client/contacts/edit.blade.php ENDPATH**/ ?>