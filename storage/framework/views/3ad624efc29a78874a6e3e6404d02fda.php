...
<div class="page-wrap capture-root">
    <div class="sheet">
        ...
        <div class="couple-photo-wrap">
            <img src="<?php echo e($imgSrc); ?>" alt="Couple photo" width="220" height="220"<?php if(!empty($pngExportScript)): ?> loading="eager" decoding="sync"<?php else: ?> loading="lazy" decoding="async"<?php endif; ?>>
        </div>
...
<?php /**PATH /home/chandlabook/public_html/resources/views/client/marriage-invitations/templates/celestial_indigo.blade.php ENDPATH**/ ?>