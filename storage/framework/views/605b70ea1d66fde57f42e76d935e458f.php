...
<body>
                ...
                <div class="cover-meta">
                    <table class="cover-meta-table">
                        ...
                        <tr>
                            ...
                            <td><?php echo e($entries->count()); ?> row<?php echo e($entries->count() === 1 ? '' : 's'); ?> · across all events</td>
                        </tr>
                        <tr>
                            <td class="lbl">Generated on</td>
                            <td><?php echo e(now()->timezone(config('app.timezone'))->format('M j, Y · g:i A')); ?></td>
                        </tr>
                    </table>
                </div>
    ...
    <div class="page-shell">
        <h2 class="section-head serif-title"><span>Summary of these <?php echo e($entries->count()); ?> entries</span></h2>
        <table class="summary-grid">
            <tr>
                ...
                <td>
                    ...
                    <div class="summary-note"><?php echo e($cash->count()); ?> <?php echo e($cash->count() === 1 ? 'row' : 'rows'); ?></div>
                </td>
                <td>
                    ...
                    <div class="summary-note"><?php echo e($cover->count()); ?> <?php echo e($cover->count() === 1 ? 'row' : 'rows'); ?></div>
                </td>
                <td>
                    <div class="summary-kicker">Gifts listed</div>
                    <div class="summary-num"><?php echo e($gift->count()); ?></div>
                    <div class="summary-note"><?php echo e($gift->count() === 1 ? 'gift row' : 'gift rows'); ?></div>
                </td>
            </tr>
        </table>
    ...
    <div class="page-shell">
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $cash; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                ...
                <?php if($cash->count() > 0): ?>
                    <tr class="total-row">
                        <td colspan="5">Section total (<?php echo e($cash->count()); ?> rows)</td>
    ...
    <div class="page-shell">
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $cover; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($i + 1); ?></td>
                        <td><?php echo e($row->giver_name); ?></td>
                        <td><?php echo e($row->event->title ?? '—'); ?></td>
                ...
                <?php if($cover->count() > 0): ?>
                    <tr class="total-row">
                        <td colspan="5">Section total (<?php echo e($cover->count()); ?> rows)</td>
    ...
    <div class="page-shell">
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $gift; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($i + 1); ?></td>
                        <td><?php echo e($row->giver_name); ?></td>
                        <td><?php echo e($row->event->title ?? '—'); ?></td>
    ...
    <div class="upgrade-page">
        ...
        <table class="upgrade-plans">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="inr">&#8377;</span> <?php echo e(number_format($familyInr, 0)); ?></td>
        ...
        <p style="margin:14px 0 0;font-size:8.5px;color:#9ca3af;text-align:center;line-height:1.45;">
            ...
            Created with Chandla Book · <?php echo e(config('app.name', 'Chandla Book')); ?>

        </p>
    </div>
</body>
</html>
<?php /**PATH /home/chandlabook/public_html/resources/views/client/chandlas/free-limit-pdf.blade.php ENDPATH**/ ?>