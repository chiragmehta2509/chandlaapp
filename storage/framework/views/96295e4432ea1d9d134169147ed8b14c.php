...
<div class="relative z-10 isolate" id="event-type-widget">
    <select id="event-type-select" name="event_type_id" class="sr-only" tabindex="-1" aria-labelledby="event-type-label">
        <option value="" <?php echo e($selectedIdStr === '' ? 'selected' : ''); ?>>Select type</option>
        <?php $__currentLoopData = $typesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($eventType->id); ?>" <?php echo e($selectedIdStr === (string) $eventType->id ? 'selected' : ''); ?>>
    ...
    <ul
        ...
        role="listbox"
        class="absolute left-0 right-0 top-full z-[80] mt-1.5 hidden rounded-[var(--cb-radius)] border border-[rgba(26,54,70,0.12)] bg-white shadow-xl shadow-slate-900/12 ring-1 ring-black/[0.04] py-1 <?php echo e($listScrollable ? 'max-h-60 overflow-y-auto overscroll-contain' : 'overflow-hidden'); ?>"
        aria-labelledby="event-type-label"
    >
        <?php $__currentLoopData = $typesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li
                role="option"
                tabindex="-1"
                data-value="<?php echo e($eventType->id); ?>"
                aria-selected="<?php echo e($selectedIdStr === (string) $eventType->id ? 'true' : 'false'); ?>"
            ...
            >
                ...
                <span class="cb-event-type-opt__label"><?php echo e($eventType->name); ?></span>
            </li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <li
            role="option"
            ...
            class="events-status-opt cb-event-type-opt cb-event-type-opt--clear <?php echo e($selectedIdStr === '' ? 'hidden' : ''); ?>"
        >
...
<?php echo $__env->make('client.events.partials.event-type-select-scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH C:\Users\Chirag\Desktop\New folder\ChandlaBook\resources\views/client/events/partials/event-type-select.blade.php ENDPATH**/ ?>