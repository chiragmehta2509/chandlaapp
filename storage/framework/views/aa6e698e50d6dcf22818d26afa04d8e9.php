...
<div class="mb-6">
    <a href="<?php echo e(route('admin.chandlas.index')); ?>" class="text-indigo-600 hover:text-indigo-800 mb-4 inline-block">
...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <div class="grid grid-cols-2 gap-6">
        ...
        <div>
            ...
            <p class="text-gray-900"><?php echo e($chandla->user->name); ?></p>
        </div>
        <div>
        ...
        <div>
            ...
            <p class="text-gray-900"><?php echo e($chandla->received_date->format('M d, Y')); ?></p>
        </div>
        <div>
        ...
        <div>
            ...
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($chandla->is_verified ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                <?php echo e($chandla->is_verified ? 'Verified' : 'Pending Verification'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/admin/chandlas/show.blade.php ENDPATH**/ ?>