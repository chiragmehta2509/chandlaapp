...
<div class="mb-6">
    <a href="<?php echo e(route('admin.users.show', $user->id)); ?>" class="text-indigo-600 hover:text-indigo-800 mb-4 inline-block">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="subscription_status" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    <option value="free" <?php echo e($user->subscription_status === 'free' ? 'selected' : ''); ?>>Free</option>
                    <option value="premium" <?php echo e($user->subscription_status === 'premium' ? 'selected' : ''); ?>>Premium</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="datetime-local" name="subscription_expires_at" 
                       value="<?php echo e(old('subscription_expires_at', $user->subscription_expires_at ? $user->subscription_expires_at->format('Y-m-d\TH:i') : '')); ?>"
                       class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
        </div>

        <div class="mt-6 flex justify-end space-x-4">
            <a href="<?php echo e(route('admin.users.show', $user->id)); ?>" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                Cancel
            </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>