...
<div class="max-w-2xl mx-auto w-full min-w-0">
    <div class="mb-6 sm:mb-8">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-5">
            ...
            <div class="min-w-0 flex-1">
                <h1 class="cb-page-title text-2xl sm:text-3xl leading-tight">Add contact</h1>
                <p class="cb-subtitle mt-1.5 max-w-xl text-sm sm:text-base leading-relaxed">
                    Save someone once — reuse them when you add ledger entries or invites.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="cb-card overflow-hidden border border-slate-200/80 shadow-sm rounded-2xl">
        <div class="px-4 py-4 sm:px-6 sm:py-5 border-b border-slate-100 bg-gradient-to-r from-slate-50/90 via-white to-amber-50/20">
            <h2 class="text-sm font-bold text-cb-navy tracking-wide">New contact</h2>
        ...
        <form method="POST" action="<?php echo e(route('client.contacts.store')); ?>" class="divide-y divide-slate-100">
            <?php echo csrf_field(); ?>
            ...
            <section class="space-y-5 p-4 sm:p-6 lg:p-8 pb-8 sm:pb-10" aria-labelledby="contact-basic-heading">
                ...
                <div class="space-y-1.5">
                    ...
                    <input id="contact-name"
                           ...
                           autocomplete="name"
                           maxlength="255"
                           class="cb-field w-full min-h-[2.75rem] text-base sm:text-sm <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-2 ring-red-100 <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="text-sm text-red-600 mt-1.5"><?php echo e($message); ?></p>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-1.5 min-w-0">
                        ...
                        <div class="relative">
                            ...
                            <input id="contact-phone"
                                   ...
                                   autocomplete="tel"
                                   class="cb-field w-full min-h-[2.75rem] !pl-10 text-base sm:text-sm <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-2 ring-red-100 <?php unset($message);
                    ...
                    <div class="space-y-1.5 min-w-0">
                        ...
                        <div class="relative">
                            ...
                            <input id="contact-email"
                                   ...
                                   autocomplete="email"
                                   class="cb-field w-full min-h-[2.75rem] !pl-10 text-base sm:text-sm <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-2 ring-red-100 <?php unset($message);
            ...
            <section class="space-y-5 p-4 sm:p-6 lg:p-8 py-8 sm:py-10" aria-labelledby="contact-address-heading">
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea id="contact-address"
                              name="address"
                              rows="3"
                              class="cb-field w-full resize-y min-h-[5.5rem] text-base sm:text-sm leading-relaxed <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-2 ring-red-100 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Flat, landmark, city…"><?php echo e(old('address')); ?></textarea>
            ...
            <section class="space-y-5 p-4 sm:p-6 lg:p-8 py-8 sm:py-10" aria-labelledby="contact-extra-heading">
                ...
                <div class="space-y-1.5">
                    ...
                    <input id="contact-relationship"
                           ...
                           class="cb-field w-full min-h-[2.75rem] text-base sm:text-sm <?php $__errorArgs = ['relationship'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-2 ring-red-100 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea id="contact-notes"
                              name="notes"
                              rows="3"
                              class="cb-field w-full resize-y min-h-[5.5rem] text-base sm:text-sm leading-relaxed <?php $__errorArgs = ['notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 ring-2 ring-red-100 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Anything you want to remember"><?php echo e(old('notes')); ?></textarea>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/client/contacts/create.blade.php ENDPATH**/ ?>