...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        <?php if(!empty($pngExportScript)): ?> body.png-royal { background: #1e1b4b !important; } <?php endif; ?>
...
<div class="capture-root">
    <p class="rh-sub"><?php echo e($d['tagline'] ?? 'Together with our families'); ?></p>
    <?php if($coupleImageOk && $imgSrc): ?>
    <div class="rh-photo">
        <img src="<?php echo e($imgSrc); ?>" alt="" width="220" height="294" <?php if(!empty($pngExportScript)): ?> loading="eager" decoding="sync" <?php else: ?> loading="lazy" <?php endif; ?>>
    </div>
    <?php endif; ?>
    <h1 class="rh-title"><?php echo e($d['groom_name'] ?? ''); ?></h1>
    <p class="rh-amp">&amp;</p>
    <h1 class="rh-title"><?php echo e($d['bride_name'] ?? ''); ?></h1>
    ...
    <div class="rh-box">
        <strong>Where</strong>
        <span style="font-family:'Playfair Display',serif;font-size:1.05rem;display:block"><?php echo e($d['venue_name'] ?? ''); ?></span>
        <div style="white-space:pre-line;margin-top:8px;font-size:.88rem;color:#475569"><?php echo e($d['venue_address'] ?? ''); ?></div>
    </div>
    <?php echo $__env->make('client.marriage-invitations.partials.schedule-block', ['d' => $d, 'wrapClass' => 'rh-sched', 'titleClass' => '', 'heading' => 'Schedule of events', 'rowClass' => 'rh-srow', 'titleCellClass' => 'rh-st', 'dotsClass' => 'rh-dots', 'whenClass' => 'rh-sw'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php if(!empty($d['rsvp_contact'])): ?><p class="rh-foot">RSVP / Contact: <?php echo e($d['rsvp_contact']); ?></p><?php endif; ?>
...
<?php /**PATH C:\Users\Chirag\Desktop\New folder\ChandlaBook\resources\views/client/marriage-invitations/templates/royal_indigo.blade.php ENDPATH**/ ?>