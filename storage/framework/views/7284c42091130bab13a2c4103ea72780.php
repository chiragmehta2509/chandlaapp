...
<div class="page-wrap capture-root">
    <div class="sheet">
        ...
        <p class="sub"><?php echo e($d['tagline'] ?? 'Together with our families'); ?></p>
        ...
        <?php if(!empty($d['rsvp_contact'])): ?>
            <div class="footer">RSVP / Contact: <?php echo e($d['rsvp_contact']); ?></div>
        <?php endif; ?>
...
<?php /**PATH C:\Users\Chirag\Desktop\New folder\ChandlaBook\resources\views/client/marriage-invitations/templates/heritage.blade.php ENDPATH**/ ?>