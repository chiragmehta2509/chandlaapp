                    ...
                    <div class="space-y-4 sm:space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                            <div>
                                ...
                                <input type="text" name="giver_phone" id="giver_phone" value="<?php echo e(old('giver_phone')); ?>" class="cb-field min-h-[48px] w-full" inputmode="tel" placeholder="Phone" required>
                            </div>
                            <div>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/client/chandlas/create.blade.php ENDPATH**/ ?>