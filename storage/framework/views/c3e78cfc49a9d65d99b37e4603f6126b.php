<?php $__currentLoopData = $milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="bg-white rounded-2xl border border-slate-200/80 p-3 flex flex-col justify-between gap-3 shadow-sm relative overflow-hidden group">
        ...
        <div class="text-center min-w-0">
            <h3 class="font-bold text-cb-navy text-xs truncate" title="<?php echo e($m['label']); ?>"><?php echo e($m['label']); ?></h3>
...
<?php if (! $__env->hasRenderedOnce('c9b44120-7746-4edf-9810-f3074b18b9fd')): $__env->markAsRenderedOnce('c9b44120-7746-4edf-9810-f3074b18b9fd'); ?>
<style>
@keyframes cb-spin    { to { transform: rotate(360deg); } }
@keyframes cb-shimmer { 0%,100% { background-position:0% 50%; } 50% { background-position:100% 50%; } }
</style>
<?php endif; ?>
<?php /**PATH /home/chandlabook/public_html/resources/views/client/pre-wedding/partials/demo-milestone-cards.blade.php ENDPATH**/ ?>