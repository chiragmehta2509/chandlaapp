...
<script>
    ...
    const PLANS = [
      ...
      },
      {
        ...
        price: <?php echo e(config('packs.celebration.amount_inr', 300)); ?>, formattedPrice: '₹<?php echo e(number_format(config('packs.celebration.amount_inr', 300), 0)); ?>',
      ...
      },
      {
        ...
        price: <?php echo e(config('packs.guest_pay_single.amount_inr', 400)); ?>, formattedPrice: '₹<?php echo e(number_format(config('packs.guest_pay_single.amount_inr', 400), 0)); ?>',
        period: 'One-Time Payment',
      ...
      },
      {
        ...
        tier: 3,
        name: 'Host Plus Plan',
        price: <?php echo e(config('packs.ledger_duo.amount_inr', 500)); ?>, formattedPrice: '₹<?php echo e(number_format(config('packs.ledger_duo.amount_inr', 500), 0)); ?>',
        period: 'One-Time Payment',
      ...
      },
      {
        ...
        tier: 4,
        name: 'Family Plan',
        price: <?php echo e(config('packs.family.amount_inr', 600)); ?>, formattedPrice: '₹<?php echo e(number_format(config('packs.family.amount_inr', 600), 0)); ?>',
        period: 'One-Time Payment',
      ...
      },
      {
        ...
        tier: 5,
        name: 'Premium Host',
        price: <?php echo e(config('packs.premium_bundle.amount_inr', 700)); ?>, formattedPrice: '₹<?php echo e(number_format(config('packs.premium_bundle.amount_inr', 700), 0)); ?>',
        period: 'One-Time Payment',
      ...
      },
      {
        ...
        tier: 6,
        name: 'Professional',
        price: <?php echo e(config('packs.professional.amount_inr', 999)); ?>, formattedPrice: '₹<?php echo e(number_format(config('packs.professional.amount_inr', 999), 0)); ?>',
        period: 'One-Time Payment',
