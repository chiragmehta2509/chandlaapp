            ...
            <div class="cover-meta">
                <table class="cover-meta-table">
                    <tr>
                        ...
                        <td class="val"><?php echo e($filterLabel); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="val"><span class="inr">&#8377; <?php echo e(number_format($totalAmount, 2)); ?></span></td>
                    </tr>
                    <tr>
    ...
    <table class="summary-grid">
        <tr>
            <td>
                ...
                <div class="summary-num"><span class="inr">&#8377; <?php echo e(number_format($totalAmount, 2)); ?></span></div>
                <div class="summary-note">All expenses combined</div>
            </td>
            <td>
                <div class="summary-kicker">Total Entries</div>
                <div class="summary-num"><?php echo e($totalEntries); ?></div>
                <div class="summary-note">Expense records</div>
            </td>
            <td>
                <div class="summary-kicker">Events Covered</div>
                <div class="summary-num"><?php echo e($byEvent->count()); ?></div>
        ...
        <tr>
            <td>
                ...
                <div class="summary-num"><span class="inr">&#8377; <?php echo e(number_format($cashAmt, 2)); ?></span></div>
                <div class="summary-note"><?php echo e($expenses->where('payment_method','cash')->count()); ?> entries</div>
            </td>
            <td style="background:#f0fdf4;border:1px solid #6ee7b7;">
                <div class="summary-kicker" style="color:#065f46;">GPay / UPI</div>
                <div class="summary-num" style="color:#065f46;"><span class="inr">&#8377; <?php echo e(number_format($gpayAmt, 2)); ?></span></div>
                <div class="summary-note"><?php echo e($expenses->where('payment_method','gpay')->count()); ?> entries</div>
            </td>
            <td>
                <div class="summary-kicker">Bank / Cheque</div>
                <div class="summary-num"><span class="inr">&#8377; <?php echo e(number_format($bankAmt + $chequeAmt, 2)); ?></span></div>
                <div class="summary-note">Transfer + cheque</div>
            </td>
        </tr>
    </table>

    <?php if($byCategory->count()): ?>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php $__currentLoopData = $byCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="text-transform:capitalize;"><?php echo e($cat); ?></td>
                    <td><?php echo e($items->count()); ?></td>
                    <td><span class="inr">&#8377; <?php echo e(number_format($items->sum('amount'), 2)); ?></span></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr class="total-row">
                    <td>Grand Total</td>
                    <td><?php echo e($totalEntries); ?></td>
                    <td><span class="inr">&#8377; <?php echo e(number_format($totalAmount, 2)); ?></span></td>
                </tr>
            </tbody>
        </table>
    <?php endif; ?>
...
<div class="page-shell">
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                <td class="whitespace-nowrap"><?php echo e($expense->expense_date?->format('d/m/Y')); ?></td>
                <td><?php echo e(optional($expense->event)->title ?? '—'); ?></td>
                <td>
                    <?php echo e($expense->title); ?>

                    <?php if($expense->description): ?>
                        <br><span style="font-size:8.5px;color:#9ca3af;"><?php echo e($expense->description); ?></span>
                    <?php endif; ?>
                </td>
                <td style="text-transform:capitalize;"><?php echo e($expense->category); ?></td>
                <td style="text-transform:capitalize;"><?php echo e(str_replace('_', ' ', $expense->payment_method)); ?></td>
                <td>
                    <?php echo e($expense->payee_name ?: '—'); ?>

                    <?php if($expense->payee_phone): ?>
                        <br><span style="font-size:8.5px;color:#9ca3af;"><?php echo e($expense->payee_phone); ?></span>
                    <?php endif; ?>
                </td>
                <td style="text-align:right;font-weight:bold;">
                    <span class="inr">&#8377; <?php echo e(number_format($expense->amount, 2)); ?></span>
                </td>
            </tr>
            ...
            <tr class="total-row">
                <td colspan="6">Grand Total — <?php echo e($totalEntries); ?> entries</td>
                <td style="text-align:right;"><span class="inr">&#8377; <?php echo e(number_format($totalAmount, 2)); ?></span></td>
            </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
<div class="page-shell">
    ...
    <table class="data-table">
        ...
        <tbody>
            <?php $__currentLoopData = $byEvent->sortByDesc(fn($g) => $g->sum('amount')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventTitle => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($eventTitle); ?></td>
                <td><?php echo e($items->count()); ?></td>
                <td style="text-align:right;font-weight:bold;">
                    <span class="inr">&#8377; <?php echo e(number_format($items->sum('amount'), 2)); ?></span>
                </td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr class="total-row">
    ...
    <?php if($pdfContactEmail !== '' || $pdfContactPhone !== '' || !empty($pdfSiteHost)): ?>
        <table class="promo-contact">
            <?php if($pdfContactEmail !== ''): ?>
                <tr><td class="pt">Email</td><td><?php echo e($pdfContactEmail); ?></td></tr>
            <?php endif; ?>
            <?php if($pdfContactPhone !== ''): ?>
                <tr><td class="pt">Phone</td><td><?php echo e($pdfContactPhone); ?></td></tr>
            <?php endif; ?>
            <?php if(!empty($pdfSiteHost)): ?>
                <tr><td class="pt">Website</td><td><?php echo e(rtrim(config('app.url'), '/')); ?></td></tr>
            <?php endif; ?>
        </table>
    <?php endif; ?>
