    ...
    <div class="rounded-2xl bg-white text-slate-800 shadow-2xl shadow-slate-950/40 ring-1 ring-white/60 overflow-hidden p-6 md:p-8 text-center">
        ...
        <div class="bg-slate-50 rounded-xl p-6 mb-6 text-left ring-1 ring-slate-100">
            ...
            <div class="space-y-2 text-sm">
                <div class="flex justify-between gap-4">
                    ...
                    <span class="font-medium text-slate-900 text-right"><?php echo e($event->title); ?></span>
                </div>
                <div class="flex justify-between gap-4">
                    <span class="text-slate-600">Your name</span>
                    <span class="font-medium text-slate-900 text-right"><?php echo e($chandla->giver_name); ?></span>
                </div>
                <div class="flex justify-between gap-4">
                    <span class="text-slate-600">Amount</span>
                    <span class="font-bold text-indigo-600 tabular-nums">₹<?php echo e(number_format($chandla->amount, 2)); ?></span>
                </div>
                <div class="flex justify-between gap-4">
                    <span class="text-slate-600">Date</span>
                    <span class="font-medium text-slate-900 text-right"><?php echo e($chandla->received_date->format('d/m/Y')); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6 text-left">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <a href="mailto:<?php echo e($event->user->email ?? ''); ?>?subject=<?php echo e(rawurlencode('Payment Confirmation - ' . $event->title)); ?>&body=<?php echo e(rawurlencode($emailBody)); ?>"
                   class="inline-flex items-center justify-center px-4 py-3 rounded-xl bg-indigo-600 text-white hover:bg-indigo-700 font-medium <?php echo e(empty($event->user->email) ? 'pointer-events-none opacity-60' : ''); ?>">
        ...
        <?php if(! empty($emailStatus)): ?>
            <div class="p-4 bg-slate-50 border border-slate-200 rounded-xl mb-6 text-left">
                ...
                <p class="text-sm text-slate-600">Guest: <?php echo e($emailStatus['giver_sent'] ? 'Sent' : 'Not sent'); ?></p>
                <p class="text-sm text-slate-600">Organiser: <?php echo e($emailStatus['organizer_sent'] ? 'Sent' : 'Not sent'); ?></p>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.public-guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/public/payment-success.blade.php ENDPATH**/ ?>