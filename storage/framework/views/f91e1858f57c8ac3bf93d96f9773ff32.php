...
<script>
(function () {
    var baseName = <?php echo json_encode($videoExportBasename ?? 'invitation', 15, 512) ?>;
    var durationSec = Math.max(5, Math.min(120, parseInt(<?php echo json_encode($videoExportDurationSec ?? 30, 15, 512) ?>, 10) || 30));
...
<?php endif; ?>
<?php /**PATH /home/chandlabook/public_html/resources/views/client/marriage-invitations/partials/export-video-script.blade.php ENDPATH**/ ?>