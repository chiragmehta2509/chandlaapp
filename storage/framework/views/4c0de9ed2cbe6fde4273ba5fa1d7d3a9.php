                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg,#1e1b4b 0%,#312e81 45%,#4c1d95 100%);background-color:#312e81;border-radius:12px 12px 0 0;padding:28px 32px;text-align:center;">
                            ...
                            <?php if(isset($message) && $logoFile): ?>
                                <img src="<?php echo e($message->embed($logoFile)); ?>" width="160" alt="Chandla Book" style="display:block;margin:0 auto 12px auto;max-width:160px;height:auto;border:0;outline:none;text-decoration:none;">
                            <?php else: ?>
                                <img src="<?php echo e(url('images/logo.jpeg')); ?>" width="160" alt="Chandla Book" style="display:block;margin:0 auto 12px auto;max-width:160px;height:auto;border:0;outline:none;text-decoration:none;">
                            <?php endif; ?>
