                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg,#1e1b4b 0%,#312e81 45%,#4c1d95 100%);background-color:#312e81;border-radius:12px 12px 0 0;padding:28px 32px;text-align:center;">
                            <?php if(file_exists(public_path('images/chandla-logo.png'))): ?>
                                <img src="<?php echo e($message->embed(public_path('images/chandla-logo.png'))); ?>" width="160" alt="Chandla Book" style="display:block;margin:0 auto 12px auto;max-width:160px;height:auto;border:0;outline:none;text-decoration:none;">
                            <?php elseif(file_exists(public_path('images/chandla-favicon.png'))): ?>
                                <img src="<?php echo e($message->embed(public_path('images/chandla-favicon.png'))); ?>" width="56" height="56" alt="" style="display:block;margin:0 auto 12px auto;border:0;">
                            <?php endif; ?>
                    ...
                    <tr>
                        <td style="background-color:#ffffff;padding:36px 32px 28px 32px;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
                            ...
                            <h1 style="margin:0 0 20px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;font-size:26px;font-weight:700;color:#0f172a;line-height:1.25;letter-spacing:-0.02em;">We’re glad you’re here, <?php echo e($user->name); ?></h1>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin:0 auto;">
                                <tr>
                                    <td style="border-radius:8px;background-color:#4f46e5;">
                                        <a href="<?php echo e(url('/client/login')); ?>" target="_blank" style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;display:inline-block;padding:14px 32px;border-radius:8px;">Sign in</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
...
<?php /**PATH C:\Users\Chirag\Desktop\New folder\ChandlaBook\resources\views/emails/welcome.blade.php ENDPATH**/ ?>