            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="col-span-1">
                    ...
                    <select name="target_audience" id="target_audience" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500" required>
                        ...
                        <option value="specific_users" <?php echo e(old('target_audience') == 'specific_users' ? 'selected' : ''); ?>>Specific Users</option>
                    </select>
                </div>
                ...
                <div class="col-span-2" id="specific_users_container" style="display: none;">
                    ...
                    <select name="specific_user_ids[]" id="specific_user_ids" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500" multiple style="height: 200px;">
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($user->id); ?>" <?php echo e(in_array($user->id, old('specific_user_ids', [])) ? 'selected' : ''); ?>>
                                <?php echo e($user->name); ?> (<?php echo e($user->phone); ?>) - <?php echo e($user->has_token ? '✅ Has Token' : '❌ No Token'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chandlabook/public_html/resources/views/admin/notifications/create.blade.php ENDPATH**/ ?>