        ...
        <div class="flex gap-4 p-4 sm:p-5">
            ...
            <div class="min-w-0 flex-1">
                ...
                <?php if($invitation->isUnlocked()): ?>
                    ...
                    <p class="text-xs text-slate-600 dark:text-slate-400 mt-1">Paid <?php echo e($invitation->paid_at?->format('M d, Y g:i A')); ?></p>
                <?php elseif($invitation->hasPendingPayment()): ?>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Chirag\Desktop\New folder\ChandlaBook\resources\views/client/marriage-invitations/show.blade.php ENDPATH**/ ?>